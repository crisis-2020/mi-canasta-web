    ...
    public partial class NuevasTablas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuarioTienas", x => new { x.Dni, x.TiendaId });
                    table.ForeignKey(
                        name: "FK_UsuarioTienas_Usuarios_Dni",
                        column: x => x.Dni,
                        principalTable: "Usuarios",
                        principalColumn: "Dni",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsuarioTienas_Tiendas_TiendaId",
                        column: x => x.TiendaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuarioTienas_TiendaId",
                table: "UsuarioTienas",
                column: "TiendaId");
        }
